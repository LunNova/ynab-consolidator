...
class AccountsApi(object):
    ...
    def get_account_by_id(self, budget_id, account_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            return self.get_account_by_id_with_http_info(
                budget_id, account_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_account_by_id_with_http_info(
                budget_id, account_id, **kwargs
            )  # noqa: E501
            return data
    ...
    def get_account_by_id_with_http_info(
        ...
        if "budget_id" not in params or params["budget_id"] is None:
            raise ValueError(
                "Missing the required parameter `budget_id` when calling `get_account_by_id`"
            )  # noqa: E501
        # verify the required parameter 'account_id' is set
        if "account_id" not in params or params["account_id"] is None:
            raise ValueError(
                "Missing the required parameter `account_id` when calling `get_account_by_id`"
            )  # noqa: E501
    ...
    def get_accounts_with_http_info(self, budget_id, **kwargs):  # noqa: E501
        ...
        if "budget_id" not in params or params["budget_id"] is None:
            raise ValueError(
                "Missing the required parameter `budget_id` when calling `get_accounts`"
            )  # noqa: E501
