...
class BudgetsApi(object):
    ...
    def get_budget_by_id(self, budget_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            return self.get_budget_by_id_with_http_info(
                budget_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_budget_by_id_with_http_info(
                budget_id, **kwargs
            )  # noqa: E501
            return data
    ...
    def get_budget_settings_by_id(self, budget_id, **kwargs):  # noqa: E501
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_budget_settings_by_id_with_http_info(
                budget_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_budget_settings_by_id_with_http_info(
                budget_id, **kwargs
            )  # noqa: E501
            return data
    ...
    def get_budget_settings_by_id_with_http_info(
        ...
        if "budget_id" not in params or params["budget_id"] is None:
            raise ValueError(
                "Missing the required parameter `budget_id` when calling `get_budget_settings_by_id`"
            )  # noqa: E501
