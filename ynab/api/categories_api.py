...
class CategoriesApi(object):
    ...
    def get_categories(self, budget_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            ...
            (data) = self.get_categories_with_http_info(
                budget_id, **kwargs
            )  # noqa: E501
            return data
    ...
    def get_categories_with_http_info(self, budget_id, **kwargs):  # noqa: E501
        ...
        if "budget_id" not in params or params["budget_id"] is None:
            raise ValueError(
                "Missing the required parameter `budget_id` when calling `get_categories`"
            )  # noqa: E501
    ...
    def get_category_by_id_with_http_info(
        ...
        if "budget_id" not in params or params["budget_id"] is None:
            raise ValueError(
                "Missing the required parameter `budget_id` when calling `get_category_by_id`"
            )  # noqa: E501
    ...
    def get_month_category_by_id(
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_month_category_by_id_with_http_info(
                budget_id, month, category_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_month_category_by_id_with_http_info(
                budget_id, month, category_id, **kwargs
            )  # noqa: E501
            return data
    ...
    def get_month_category_by_id_with_http_info(
        ...
        if "budget_id" not in params or params["budget_id"] is None:
            raise ValueError(
                "Missing the required parameter `budget_id` when calling `get_month_category_by_id`"
            )  # noqa: E501
        # verify the required parameter 'month' is set
        if "month" not in params or params["month"] is None:
            raise ValueError(
                "Missing the required parameter `month` when calling `get_month_category_by_id`"
            )  # noqa: E501
        # verify the required parameter 'category_id' is set
        if "category_id" not in params or params["category_id"] is None:
            raise ValueError(
                "Missing the required parameter `category_id` when calling `get_month_category_by_id`"
            )  # noqa: E501
    ...
    def update_month_category(
        self, body, budget_id, month, category_id, **kwargs
    ):  # noqa: E501
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.update_month_category_with_http_info(
                body, budget_id, month, category_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.update_month_category_with_http_info(
                body, budget_id, month, category_id, **kwargs
            )  # noqa: E501
            return data
    ...
    def update_month_category_with_http_info(
        ...
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `update_month_category`"
            )  # noqa: E501
        # verify the required parameter 'budget_id' is set
        if "budget_id" not in params or params["budget_id"] is None:
            raise ValueError(
