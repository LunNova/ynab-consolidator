...
class DeprecatedApi(object):
    ...
    def bulk_create_transactions(self, body, budget_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            return self.bulk_create_transactions_with_http_info(
                body, budget_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.bulk_create_transactions_with_http_info(
                body, budget_id, **kwargs
            )  # noqa: E501
            return data

    def bulk_create_transactions_with_http_info(
        ...
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `bulk_create_transactions`"
            )  # noqa: E501
        # verify the required parameter 'budget_id' is set
        if "budget_id" not in params or params["budget_id"] is None:
            raise ValueError(
                "Missing the required parameter `budget_id` when calling `bulk_create_transactions`"
            )  # noqa: E501
