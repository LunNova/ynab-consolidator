...
class MonthsApi(object):
    ...
    def get_budget_month(self, budget_id, month, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            return self.get_budget_month_with_http_info(
                budget_id, month, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_budget_month_with_http_info(
                budget_id, month, **kwargs
            )  # noqa: E501
            return data
    ...
    def get_budget_month_with_http_info(self, budget_id, month, **kwargs):  # noqa: E501
        ...
        if "budget_id" not in params or params["budget_id"] is None:
            raise ValueError(
                "Missing the required parameter `budget_id` when calling `get_budget_month`"
            )  # noqa: E501
        # verify the required parameter 'month' is set
        if "month" not in params or params["month"] is None:
            raise ValueError(
                "Missing the required parameter `month` when calling `get_budget_month`"
            )  # noqa: E501
    ...
    def get_budget_months(self, budget_id, **kwargs):  # noqa: E501
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_budget_months_with_http_info(
                budget_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_budget_months_with_http_info(
                budget_id, **kwargs
            )  # noqa: E501
            return data
    ...
    def get_budget_months_with_http_info(self, budget_id, **kwargs):  # noqa: E501
        ...
        if "budget_id" not in params or params["budget_id"] is None:
            raise ValueError(
                "Missing the required parameter `budget_id` when calling `get_budget_months`"
            )  # noqa: E501
