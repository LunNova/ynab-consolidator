...
class ScheduledTransactionsApi(object):
    ...
    def get_scheduled_transaction_by_id(
        self, budget_id, scheduled_transaction_id, **kwargs
    ):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            return self.get_scheduled_transaction_by_id_with_http_info(
                budget_id, scheduled_transaction_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_scheduled_transaction_by_id_with_http_info(
                budget_id, scheduled_transaction_id, **kwargs
            )  # noqa: E501
            return data

    def get_scheduled_transaction_by_id_with_http_info(
        self, budget_id, scheduled_transaction_id, **kwargs
    ):  # noqa: E501
        """Single scheduled transaction  # noqa: E501
        ...
        if "budget_id" not in params or params["budget_id"] is None:
            raise ValueError(
                "Missing the required parameter `budget_id` when calling `get_scheduled_transaction_by_id`"
            )  # noqa: E501
        # verify the required parameter 'scheduled_transaction_id' is set
        if (
            "scheduled_transaction_id" not in params
            or params["scheduled_transaction_id"] is None
        ):
            raise ValueError(
                "Missing the required parameter `scheduled_transaction_id` when calling `get_scheduled_transaction_by_id`"
            )  # noqa: E501
        ...
        if "scheduled_transaction_id" in params:
            path_params["scheduled_transaction_id"] = params[
    ...
    def get_scheduled_transactions(self, budget_id, **kwargs):  # noqa: E501
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_scheduled_transactions_with_http_info(
                budget_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_scheduled_transactions_with_http_info(
                budget_id, **kwargs
            )  # noqa: E501
            return data

    def get_scheduled_transactions_with_http_info(
        ...
        if "budget_id" not in params or params["budget_id"] is None:
            raise ValueError(
                "Missing the required parameter `budget_id` when calling `get_scheduled_transactions`"
            )  # noqa: E501
