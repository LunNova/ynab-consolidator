...
class Account(object):
    ...
    def on_budget(self, on_budget):
        ...
        if on_budget is None:
            raise ValueError(
                "Invalid value for `on_budget`, must not be `None`"
            )  # noqa: E501
    ...
    def closed(self, closed):
        ...
        if closed is None:
            raise ValueError(
                "Invalid value for `closed`, must not be `None`"
            )  # noqa: E501
    ...
    def cleared_balance(self, cleared_balance):
        ...
        if cleared_balance is None:
            raise ValueError(
                "Invalid value for `cleared_balance`, must not be `None`"
            )  # noqa: E501
    ...
    def uncleared_balance(self, uncleared_balance):
        ...
        if uncleared_balance is None:
            raise ValueError(
                "Invalid value for `uncleared_balance`, must not be `None`"
            )  # noqa: E501
    ...
    def transfer_payee_id(self, transfer_payee_id):
        ...
        if transfer_payee_id is None:
            raise ValueError(
                "Invalid value for `transfer_payee_id`, must not be `None`"
            )  # noqa: E501
