...
class BudgetSettings(object):
    ...
    """
    swagger_types = {"date_format": "DateFormat", "currency_format": "CurrencyFormat"}

    attribute_map = {"date_format": "date_format", "currency_format": "currency_format"}
    ...
    def date_format(self, date_format):
        ...
        if date_format is None:
            raise ValueError(
                "Invalid value for `date_format`, must not be `None`"
            )  # noqa: E501
    ...
    def currency_format(self, currency_format):
        ...
        if currency_format is None:
            raise ValueError(
                "Invalid value for `currency_format`, must not be `None`"
            )  # noqa: E501
