...
class Category(object):
    ...
    def category_group_id(self, category_group_id):
        ...
        if category_group_id is None:
            raise ValueError(
                "Invalid value for `category_group_id`, must not be `None`"
            )  # noqa: E501
    ...
    def budgeted(self, budgeted):
        ...
        if budgeted is None:
            raise ValueError(
                "Invalid value for `budgeted`, must not be `None`"
            )  # noqa: E501
    ...
    def activity(self, activity):
        ...
        if activity is None:
            raise ValueError(
                "Invalid value for `activity`, must not be `None`"
            )  # noqa: E501
    ...
    def goal_type(self, goal_type):
        ...
        if goal_type is None:
            raise ValueError(
                "Invalid value for `goal_type`, must not be `None`"
            )  # noqa: E501
        allowed_values = ["TB", "TBD", "MF"]  # noqa: E501
        if goal_type not in allowed_values:
            raise ValueError(
                "Invalid value for `goal_type` ({0}), must be one of {1}".format(  # noqa: E501
                    goal_type, allowed_values
                )
            )
    ...
    def goal_creation_month(self, goal_creation_month):
        ...
        if goal_creation_month is None:
            raise ValueError(
                "Invalid value for `goal_creation_month`, must not be `None`"
            )  # noqa: E501
    ...
    def goal_target(self, goal_target):
        ...
        if goal_target is None:
            raise ValueError(
                "Invalid value for `goal_target`, must not be `None`"
            )  # noqa: E501
    ...
    def goal_target_month(self, goal_target_month):
        ...
        if goal_target_month is None:
            raise ValueError(
                "Invalid value for `goal_target_month`, must not be `None`"
            )  # noqa: E501
    ...
    def goal_percentage_complete(self, goal_percentage_complete):
        ...
        if goal_percentage_complete is None:
            raise ValueError(
                "Invalid value for `goal_percentage_complete`, must not be `None`"
            )  # noqa: E501
