...
class CurrencyFormat(object):
    ...
    def iso_code(self, iso_code):
        ...
        if iso_code is None:
            raise ValueError(
                "Invalid value for `iso_code`, must not be `None`"
            )  # noqa: E501
    ...
    def example_format(self, example_format):
        ...
        if example_format is None:
            raise ValueError(
                "Invalid value for `example_format`, must not be `None`"
            )  # noqa: E501
    ...
    def decimal_digits(self, decimal_digits):
        ...
        if decimal_digits is None:
            raise ValueError(
                "Invalid value for `decimal_digits`, must not be `None`"
            )  # noqa: E501
    ...
    def decimal_separator(self, decimal_separator):
        ...
        if decimal_separator is None:
            raise ValueError(
                "Invalid value for `decimal_separator`, must not be `None`"
            )  # noqa: E501
    ...
    def symbol_first(self, symbol_first):
        ...
        if symbol_first is None:
            raise ValueError(
                "Invalid value for `symbol_first`, must not be `None`"
            )  # noqa: E501
    ...
    def group_separator(self, group_separator):
        ...
        if group_separator is None:
            raise ValueError(
                "Invalid value for `group_separator`, must not be `None`"
            )  # noqa: E501
    ...
    def currency_symbol(self, currency_symbol):
        ...
        if currency_symbol is None:
            raise ValueError(
                "Invalid value for `currency_symbol`, must not be `None`"
            )  # noqa: E501
    ...
    def display_symbol(self, display_symbol):
        ...
        if display_symbol is None:
            raise ValueError(
                "Invalid value for `display_symbol`, must not be `None`"
            )  # noqa: E501
