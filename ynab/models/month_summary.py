...
class MonthSummary(object):
    ...
    def month(self, month):
        ...
        if month is None:
            raise ValueError(
                "Invalid value for `month`, must not be `None`"
            )  # noqa: E501
    ...
    def income(self, income):
        ...
        if income is None:
            raise ValueError(
                "Invalid value for `income`, must not be `None`"
            )  # noqa: E501
    ...
    def to_be_budgeted(self, to_be_budgeted):
        ...
        if to_be_budgeted is None:
            raise ValueError(
                "Invalid value for `to_be_budgeted`, must not be `None`"
            )  # noqa: E501
    ...
    def age_of_money(self, age_of_money):
        ...
        if age_of_money is None:
            raise ValueError(
                "Invalid value for `age_of_money`, must not be `None`"
            )  # noqa: E501
