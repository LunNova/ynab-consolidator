...
import six
from ynab.models.scheduled_sub_transaction import (
    ScheduledSubTransaction,
)  # noqa: F401,E501
from ynab.models.scheduled_transaction_summary import (
...
class ScheduledTransactionDetail(ScheduledTransactionSummary):
    ...
    def payee_name(self, payee_name):
        ...
        if payee_name is None:
            raise ValueError(
                "Invalid value for `payee_name`, must not be `None`"
            )  # noqa: E501
    ...
    def subtransactions(self, subtransactions):
        ...
        if subtransactions is None:
            raise ValueError(
                "Invalid value for `subtransactions`, must not be `None`"
            )  # noqa: E501
