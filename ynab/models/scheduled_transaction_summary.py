...
class ScheduledTransactionSummary(object):
    ...
    def date_first(self, date_first):
        ...
        if date_first is None:
            raise ValueError(
                "Invalid value for `date_first`, must not be `None`"
            )  # noqa: E501
    ...
    def date_next(self, date_next):
        ...
        if date_next is None:
            raise ValueError(
                "Invalid value for `date_next`, must not be `None`"
            )  # noqa: E501
    ...
    def frequency(self, frequency):
        ...
        if frequency not in allowed_values:
            raise ValueError(
                "Invalid value for `frequency` ({0}), must be one of {1}".format(  # noqa: E501
                    frequency, allowed_values
                )
            )
