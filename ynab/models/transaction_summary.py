...
class TransactionSummary(object):
    ...
    def memo(self, memo):
        ...
        if memo is None:
            raise ValueError(
                "Invalid value for `memo`, must not be `None`"
            )  # noqa: E501
    ...
    def cleared(self, cleared):
        ...
        if cleared is None:
            raise ValueError(
                "Invalid value for `cleared`, must not be `None`"
            )  # noqa: E501
        allowed_values = ["cleared", "uncleared", "reconciled"]  # noqa: E501
        if cleared not in allowed_values:
            raise ValueError(
                "Invalid value for `cleared` ({0}), must be one of {1}".format(  # noqa: E501
                    cleared, allowed_values
                )
            )
    ...
    def approved(self, approved):
        ...
        if approved is None:
            raise ValueError(
                "Invalid value for `approved`, must not be `None`"
            )  # noqa: E501
    ...
    def flag_color(self, flag_color):
        ...
        if flag_color is None:
            raise ValueError(
                "Invalid value for `flag_color`, must not be `None`"
            )  # noqa: E501
        allowed_values = [
            "red",
            "orange",
        ...
        if flag_color not in allowed_values:
            raise ValueError(
                "Invalid value for `flag_color` ({0}), must be one of {1}".format(  # noqa: E501
                    flag_color, allowed_values
                )
            )
    ...
    def transfer_account_id(self, transfer_account_id):
        ...
        if transfer_account_id is None:
            raise ValueError(
                "Invalid value for `transfer_account_id`, must not be `None`"
            )  # noqa: E501
    ...
    def transfer_transaction_id(self, transfer_transaction_id):
        ...
        if transfer_transaction_id is None:
            raise ValueError(
                "Invalid value for `transfer_transaction_id`, must not be `None`"
            )  # noqa: E501
    ...
    def matched_transaction_id(self, matched_transaction_id):
        ...
        if matched_transaction_id is None:
            raise ValueError(
                "Invalid value for `matched_transaction_id`, must not be `None`"
            )  # noqa: E501
    ...
    def import_id(self, import_id):
        ...
        if import_id is None:
            raise ValueError(
                "Invalid value for `import_id`, must not be `None`"
            )  # noqa: E501
    ...
    def deleted(self, deleted):
        ...
        if deleted is None:
            raise ValueError(
                "Invalid value for `deleted`, must not be `None`"
            )  # noqa: E501
